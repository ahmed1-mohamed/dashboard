        ...
        <TableHeader>
          <TableRow className="bg-gray-50 hover:bg-gray-50">
            ...
            {settings.isColumnVisible("developer") && (
              <TableHead className="font-semibold text-gray-900 w-[140px] px-2 text-sm">Developer</TableHead>
            )}
            {settings.isColumnVisible("country") && (
              <TableHead className="font-semibold text-gray-900 w-[100px] px-2 text-sm">Country</TableHead>
            )}
            {settings.isColumnVisible("city") && (
              <TableHead className="font-semibold text-gray-900 w-[80px] px-2 text-sm">City</TableHead>
            )}
            {settings.isColumnVisible("projects") && (
              <TableHead className="font-semibold text-gray-900 w-[70px] px-2 text-sm">Projects</TableHead>
            )}
            {settings.isColumnVisible("website") && (
              <TableHead className="font-semibold text-gray-900 w-[130px] px-2 text-sm">Website</TableHead>
            )}
            {settings.isColumnVisible("email") && (
              <TableHead className="font-semibold text-gray-900 w-[180px] px-2 text-sm">Email</TableHead>
            )}
            {settings.isColumnVisible("contact") && (
              <TableHead className="font-semibold text-gray-900 w-[120px] px-2 text-sm">Contact</TableHead>
            )}
            ...
            {settings.isColumnVisible("actions") && (
              <TableHead className="font-semibold text-gray-900 w-[100px] px-2 text-sm">Actions</TableHead>
            )}
          </TableRow>
        </TableHeader>
        <TableBody>
            {developers.map((developer) => (
              ...
              >
                ...
                {settings.isColumnVisible("city") && (
                  <TableCell
                    className={`text-gray-900 px-2 text-sm truncate max-w-[80px] ${densityClass}`}
                ...
                {settings.isColumnVisible("email") && (
                  <TableCell className={`text-gray-900 px-2 text-sm truncate max-w-[160px] ${densityClass}`}>
                    {developer.email}
                  </TableCell>
                )}
                {settings.isColumnVisible("contact") && (
