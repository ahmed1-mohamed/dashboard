...
export default function EditAdPage() {
  ...
  // Create a mock 'ad' object using the ID from the URL so useAdEditData can fetch it
  const ad = { creative_id: id } as any;
  const isOpen = true;
  ...
  const onSubmit = async (data: EditAdFormData) => {
    ...
    try {
      await updateAd({ adId: Number(ad!.creative_id), formData });
              ...
              <div>
                ...
                <div className="relative">
                  <Input
                    ...
                    className={`bg-gray-50 pl-10 ${dateErrors.startDate
              ...
              <div>
                ...
                <div className="relative">
                  <Input
                    ...
                    type="date"
                    {...register("endDate")}
                    className={`bg-gray-50 pl-10 ${dateErrors.endDate
                        ? "border-red-500 focus-visible:ring-red-500"
                        : "border-gray-200"
                      }`}
