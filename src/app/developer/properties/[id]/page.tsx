...
// import { EditDeveloperPropertyModal } from "@/components/modals/edit-developer-property-modal";
...
//         features:
//           property.features?.map((f: any, index: number) => ({
//             ...f,
