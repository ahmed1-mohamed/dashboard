...
// import { EditDeveloperProjectModal } from "@/components/modals/edit-developer-project-modal";
// import { AddFeatureModal } from "@/components/modals/add-feature-modal";
// import { EditFeatureModal } from "@/components/modals/edit-feature-modal";
...
//                     {data.properties?.length || 0} units available
//                   </h3>
//                   <p className="text-sm text-gray-500 mb-6 text-center max-w-sm">
//                     {data.properties?.length
//                       ? "View unit details in the properties section"
//                       : "Add units to this project to manage inventory and availability."}
//                   </p>
//                   <Button className="bg-teal-600 hover:bg-teal-700 text-white gap-2">
//                     <Plus className="h-4 w-4" />
//                     Add Unit
