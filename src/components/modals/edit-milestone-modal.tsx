...
import {
  milestoneSchema,
  MilestoneSchema,
} from "@/validators/milestone.schema";
...
export function EditMilestoneModal({
  ...
  // const { milestoneQuery, editMutation } = useMilestone(milestoneId, projectId, token);

  // const { data, isLoading } = milestoneQuery;
  ...
  //     });
  //   }
  // }, [data, reset, projectId]);

  // const mutation = useMutation({
  //   mutationFn: editMutation.mutate,
  //   onSuccess: () => {
