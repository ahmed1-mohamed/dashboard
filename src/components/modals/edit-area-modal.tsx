    ...
    >
      <div ref={modalContentRef} className="max-h-[70vh] overflow-y-auto pr-2">
        <form onSubmit={handleSubmit(onSubmitForm)} className="space-y-5">
          ...
          {/* Area Name */}
          <div>
            <Label htmlFor="dld_area_name_edit">
              Area Name <span className="text-red-500">*</span>
            </Label>
            <Input
              id="dld_area_name_edit"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <Label htmlFor="latitude_edit">Latitude</Label>
              <Input
                id="latitude_edit"
                type="number"
                step="any"
            ...
            <div>
              <Label htmlFor="longitude_edit">Longitude</Label>
              <Input
                id="longitude_edit"
                type="number"
                step="any"
