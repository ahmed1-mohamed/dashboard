...
export function BulkImportProjectsModal({
  ...
  const prepareFormData = () => {
    ...
    // Add the remove non-existing data flag
    if (isChecked2) {
  ...
  const handleUpload = async () => {
    ...
    if (projectId == null || projectId == 0) {
      toast.error("Project ID is not valid");
      return;
    }
    ...
    try {
      ...
      if (response.ok) {
        ...
        toast.error(
          `Upload error: ${result.message || "Something went wrong"}`,
        );
        setIsUploaded(false);
  ...
  const downloadFilledFile = async () => {
    ...
    setIsDownloading(true);
    PropertiesFilledTemplate(projectId, token!);
    setIsDownloading(false);
  };
      ...
      <div className="space-y-6 max-h-[70vh] overflow-y-auto">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          <p className="text-sm text-blue-800">
            Upload an Excel or CSV file containing project data to import them
            in bulk. Make sure your file follows the required template format.
          </p>
        </div>
          ...
          <div className="flex items-start gap-3 mb-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-gray-600 mb-3">
                Download the appropriate template to ensure your data is
                formatted correctly.
              </p>
