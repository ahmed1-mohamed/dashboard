...
// Main items that are always visible at the top
const mainItems = [
...
// Bottom items that are always visible
const bottomItems = [
...
export function Sidebar() {
  ...
  // Check if user role (role_id = 3)
  const isDeveloperRole = role_id === 3;

  // Check if admin role (role_id = 2)
  const isAdminRole = role_id === 2;

  // Check if expert role (role_id = 1)
  const isExpertRole = role_id === 6;

  // Check if any item in a tab group is active
